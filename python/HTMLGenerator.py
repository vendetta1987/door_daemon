...
"""
Concrete implementation of a HTML generator which creates
a table depiction of the data stored in the logfile.
"""
class LogfileToHTMLTableGenerator(AbstractHTMLGenerator):

	def __init__(self):
		pass

	def generateTableHeader(self, def_class="def_class", def_id="def_id", border_thickness="1"):
		header = "<table "

		if not def_class == "def_class":
			header += "class=" + def_class + " "

		if not def_class == "def_id":
			header += "id=" + def_id + " "
